...
|---------|-------------------|-------------------------------------|-------|---------------------|-----------------|
| **Do**  | 1:1   | *(Base — terminal, no digit)* | 0.00 | C4 | The origin. |
| **Ra**  | 16:15 | `+4/Du, −1/Tri, −1/Qui` | +111.73 | Db4 | Descending a major third and a perfect fifth from the Du ceiling. |
| **Re**  | 9:8   | `+2/Tri, −3/Du` | +203.91 | D4 | Ascending two perfect fifths (Tri). |
...
| **Fi**  | √2:1  | `+1/Boundary` | ±600.00 | F#4 *(by convention — see note)* | The Boundary of Do's local period space. |
...
| **Te**  | 7/8   | `+1/Sep, −3/Du` | **−231.17** | **Bb3** *(flat)* | The 7-limit harmonic seventh, reduced to nearest address. |
| **Ti**  | 15/16 | `+1/Qui, +1/Tri, −4/Du` | **−111.73** | **B3** | Ascending a major third and a perfect fifth, reduced to nearest address. |
