...
Starting from a base frequency, moving up a fifth multiplies the frequency by 3/2. Doing this 12 times produces a sequence of 12 notes (the "Circle of Fifths"). Mathematically, this yields (3/2)<sup>12</sup>, which equals exactly 129.746. 

However, moving up exactly 7 octaves gives a multiplier of 2<sup>7</sup>, which is exactly 128. 

Because 3<sup>12</sup> does not equal 2<sup>19</sup> (or any power of 2), a cycle of pure 3:2 fifths *never* closes perfectly at an octave. 
